...
public class ManagerController {
    ...
    public String managerDashboard(Authentication authentication, Model model) {
        try {
            ...
            for (Booking booking : allBookings) {
                List<TechnicianAssignment> bookingAssignments = assignmentService.getAssignmentsByBooking(booking.getId());
    ...
    public ResponseEntity<String> assignTechnicianToBooking(@RequestParam Long bookingId, 
        ...
        try {
            ...
            if (booking.isPresent() && technician.isPresent()) {
                ...
                // Create assignment using unified service
                TechnicianAssignment assignment = assignmentService.assignTechnicianToBooking(bookingId, technicianId, currentUser, notes, assignmentDateTime);
    ...
    public ResponseEntity<String> unassignTechnician(@RequestParam Long bookingId,
        ...
        try {
            ...
            if (booking.isPresent()) {
                ...
                List<TechnicianAssignment> assignments = assignmentService.getAssignmentsByBooking(booking.get().getId());
                for (TechnicianAssignment assignment : assignments) {
    ...
    public ResponseEntity<List<Map<String, Object>>> getTechnicianWorkload(Authentication authentication) {
        try {
            ...
            for (Technician technician : technicians) {
                ...
                List<TechnicianAssignment> assignments = assignmentService.getAssignmentsByTechnician(technician.getId());
    ...
    @ResponseBody
    public ResponseEntity<TechnicianAssignment> getAssignmentById(@PathVariable Long id, Authentication authentication) {
        try {
    ...
    @ResponseBody
    public ResponseEntity<String> deleteAssignmentsByBooking(@PathVariable Long bookingId, Authentication authentication) {
        try {
            Optional<Booking> booking = bookingService.getBookingById(bookingId);
            if (booking.isPresent()) {
    ...
    public ResponseEntity<String> exportAssignments(Authentication authentication) {
        try {
            ...
            for (TechnicianAssignment assignment : assignments) {
                ...
                csv.append(assignment.getTechnician().getUser().getFirstName() + " " + assignment.getTechnician().getUser().getLastName()).append(",");
                csv.append(assignment.getAssignedBy().getFirstName() + " " + assignment.getAssignedBy().getLastName()).append(",");
    ...
    @ResponseBody
    public ResponseEntity<List<AssignmentService.TechnicianWithAssignments>> 
            getAllTechniciansWithAssignments(Authentication authentication) {
        try {
            List<AssignmentService.TechnicianWithAssignments> techniciansWithAssignments = 
                assignmentService.getAllTechniciansWithAssignments();
    ...
    @ResponseBody
    public ResponseEntity<AssignmentService.TechnicianWithAssignments> 
            getTechnicianWithAssignments(@PathVariable Long id, Authentication authentication) {
        try {
            AssignmentService.TechnicianWithAssignments technicianWithAssignments = 
                assignmentService.getTechnicianWithAssignments(id);
    ...
    @ResponseBody
    public ResponseEntity<AssignmentService.TechnicianWorkloadStats> 
            getTechnicianWorkloadStats(@PathVariable Long id, Authentication authentication) {
        try {
            AssignmentService.TechnicianWorkloadStats stats = 
                assignmentService.getTechnicianWorkloadStats(id);
            if (stats != null) {
    ...
    public ResponseEntity<?> getFeedbackStats(Authentication authentication) {
        try {
            ...
            long goodFeedbacks = allFeedbacks.stream()
                    ...
                    .count();
            long averageRating = totalFeedbacks > 0 ? 
                    (long) allFeedbacks.stream()
