...
public interface TechnicianAssignmentRepository extends JpaRepository<TechnicianAssignment, Long> {
    ...
    List<TechnicianAssignment> findByAssignmentDateBetweenOrderByAssignmentDateDesc(LocalDateTime startDate, LocalDateTime endDate);
    ...
    long countByTechnicianAndStatus(@Param("technician") Technician technician, @Param("status") TechnicianAssignment.AssignmentStatus status);
    ...
    List<TechnicianAssignment> findByTechnicianAndDateRange(@Param("technician") Technician technician, @Param("startDate") LocalDateTime startDate, @Param("endDate") LocalDateTime endDate);
